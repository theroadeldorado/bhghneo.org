          ...
          <div class="w-[calc(50%-12px)] md:w-[265px] shrink-0">
            <div class="flex items-center flex-col gap-0.5 md:gap-1 text-center rounded-md bg-gray-50 shadow-md py-3 md:py-6 px-2">
              ...
              <?php if($phone_number_extension):?>
                <a href="tel:<?php echo $phone_number_extension;?>" class="flex flex-col text-[11px] md:text-sm items-center justify-center text-blue-2 hover:underline"><?php echo $phone_number_extension;?></a>
              <?php endif;?>
              <?php if($email):?>
